...
// configuration step. It creates a namespace called `AofCode_Cpp`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", AofCode_Cpp::cmake::project_name, AofCode_Cpp::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", AofCode_Cpp::cmake::project_version);
      return EXIT_SUCCESS;
    }
